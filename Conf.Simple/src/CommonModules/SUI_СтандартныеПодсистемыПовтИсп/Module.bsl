...
Функция ИменаПодсистем() Экспорт
	...
	Попытка
		МодульСтандартныеПодсистемыПовтИсп = SUI_ОбщегоНазначения.ОбщийМодуль("СтандартныеПодсистемыПовтИсп");
		Имена = МодульСтандартныеПодсистемыПовтИсп.ИменаПодсистем();
	Исключение
		ВставитьИменаПодчиненныхПодсистем(Имена, Метаданные);
	КонецПопытки;
	
	Если ТипЗнч(Имена) = Тип("ФиксированноеСоответствие") Тогда
		Возврат Имена;
	Иначе
