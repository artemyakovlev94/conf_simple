...
//
// Параметры: 
//   ПараметрыШтрихкода - см. SUI_ГенерацияШтрихкода.ПараметрыГенерацииШтрихкода
//
// Возвращаемое значение: 
//   Структура:
...
Функция ДанныеQRКода(QRСтрока, УровеньКоррекции, Размер) Экспорт
	...
	Попытка
		...
		Если РезультатФормированияШтрихкода.Результат Тогда
...
#КонецЕсли
	...
	Если SUI_ОбщегоНазначения.ПодсистемаСуществует("СтандартныеПодсистемы.ВнешниеКомпоненты") Тогда
		МодульВнешниеКомпонентыСервер = SUI_ОбщегоНазначения.ОбщийМодуль("ВнешниеКомпонентыСервер");
	...
	Если ВнешняяКомпонента = Неопределено Тогда 
		ВнешняяКомпонента = ОбщегоНазначения.ПодключитьКомпонентуИзМакета("Barcode", "ОбщийМакет.SUI_КомпонентаПечатиШтрихкодов");
	КонецЕсли;
...
//
// Параметры:
//   ВнешняяКомпонента - см. SUI_ГенерацияШтрихкодаПовтИсп.ПодключитьКомпонентуГенерацииИзображенияШтрихкода
//
