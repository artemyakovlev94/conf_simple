...
Функция ПредопределенныеАлгоритмыСозданияСерий() Экспорт
	
	ПредопределенныеАлгоритмы = Новый СписокЗначений();
	ПредопределенныеАлгоритмы.Добавить(
		ПредопределенныеАлгоритмыСозданияСерийУправлениеТорговлей11(),
...
Функция ИмяСобытия() Экспорт
	Возврат НСтр("ru = 'Серии номенклатуры'");
КонецФункции

Функция ПредопределенныеАлгоритмыСозданияСерийУправлениеТорговлей11()
	
	Возврат "Запрос = Новый Запрос;
