...
Функция ТаблицаПолейXMLОписанияМакета()
	...
	Таблица.Колонки.Добавить("Наименование", SUI_ОбщегоНазначения.ОписаниеТипаСтрока(50));
	Таблица.Колонки.Добавить("Тип", SUI_ОбщегоНазначения.ОписаниеТипаСтрока(10));
	Таблица.Колонки.Добавить("Значение", SUI_ОбщегоНазначения.ОписаниеТипаСтрока(0));
	Таблица.Колонки.Добавить("Лево", SUI_ОбщегоНазначения.ОписаниеТипаЧисло(4, 1, ДопустимыйЗнак.Неотрицательный));
	Таблица.Колонки.Добавить("Право", SUI_ОбщегоНазначения.ОписаниеТипаЧисло(4, 1, ДопустимыйЗнак.Неотрицательный));
	Таблица.Колонки.Добавить("Верх", SUI_ОбщегоНазначения.ОписаниеТипаЧисло(4, 1, ДопустимыйЗнак.Неотрицательный));
	Таблица.Колонки.Добавить("Низ", SUI_ОбщегоНазначения.ОписаниеТипаЧисло(4, 1, ДопустимыйЗнак.Неотрицательный));
	Таблица.Колонки.Добавить("Ориентация", SUI_ОбщегоНазначения.ОписаниеТипаЧисло(3, , ДопустимыйЗнак.Неотрицательный));
	Таблица.Колонки.Добавить("ИмяШрифта", SUI_ОбщегоНазначения.ОписаниеТипаСтрока(50));
	Таблица.Колонки.Добавить("РазмерШрифта", SUI_ОбщегоНазначения.ОписаниеТипаЧисло(2, , ДопустимыйЗнак.Неотрицательный));
	...
	Таблица.Колонки.Добавить("ТипРамки", SUI_ОбщегоНазначения.ОписаниеТипаСтрока(6));
	Таблица.Колонки.Добавить("ТолщинаРамки", SUI_ОбщегоНазначения.ОписаниеТипаЧисло(1, , ДопустимыйЗнак.Неотрицательный));	
	Таблица.Колонки.Добавить("ТипШтрихкода", SUI_ОбщегоНазначения.ОписаниеТипаСтрока(30));
	Таблица.Колонки.Добавить("ПодписьШтрихкода", Новый ОписаниеТипов("Булево"));
	Таблица.Колонки.Добавить("РазмерШрифтаПодписи", SUI_ОбщегоНазначения.ОписаниеТипаЧисло(2, , ДопустимыйЗнак.Неотрицательный));
	Таблица.Колонки.Добавить("ПоложениеПоГоризонтали", SUI_ОбщегоНазначения.ОписаниеТипаСтрока(6));
	Таблица.Колонки.Добавить("ПоложениеПоВертикали", SUI_ОбщегоНазначения.ОписаниеТипаСтрока(6));
	...
	Таблица.Колонки.Добавить("ТипЗаполнения", SUI_ОбщегоНазначения.ОписаниеТипаСтрока(9));
	Таблица.Колонки.Добавить("ЗначениеПоУмолчанию", SUI_ОбщегоНазначения.ОписаниеТипаСтрока(0));
	Таблица.Колонки.Добавить("Представление", SUI_ОбщегоНазначения.ОписаниеТипаСтрока(0));
	Таблица.Колонки.Добавить("Формат", SUI_ОбщегоНазначения.ОписаниеТипаСтрока(0));
...
Функция ЭтоКартинка(Файл)
	Возврат SUI_ОбщегоНазначенияКлиентСервер.МассивЗначений(".png", ".jpg", ".jpeg", ".svg").Найти(Файл.Расширение) <> Неопределено;
КонецФункции
...
Функция ТаблицаФайлыКаталогаФайлаHTML()
	...
	Таблица.Колонки.Добавить("Имя", SUI_ОбщегоНазначения.ОписаниеТипаСтрока(100));
	Таблица.Колонки.Добавить("СтрокаBase64", SUI_ОбщегоНазначения.ОписаниеТипаСтрока(0));
